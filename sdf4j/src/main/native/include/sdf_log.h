 ...
 */
#ifdef NDEBUG
    #define SDF_LOG_ENTER(func_name)  ((void)0)
#else
    #define SDF_LOG_ENTER(func_name) SDF_JNI_LOG("ENTER: %s", func_name)
#endif
 ...
 */
#ifdef NDEBUG
    #define SDF_LOG_EXIT(func_name, ret_code)  ((void)0)
#else
    #define SDF_LOG_EXIT(func_name, ret_code) SDF_JNI_LOG("EXIT: %s, ret=0x%08X", func_name, (unsigned int)(ret_code))
#endif
 ...
 */
#ifdef NDEBUG
    #define SDF_LOG_ERROR(func_name, error_msg)  ((void)0)
#else
    #define SDF_LOG_ERROR(func_name, error_msg) SDF_JNI_LOG("ERROR: %s - %s", func_name, error_msg)
#endif
 ...
 */
#ifdef NDEBUG
    #define SDF_LOG_HEX(label, data, len)  ((void)0)
#else
