...
static jint init_ecc_public_key_cache(JNIEnv *env) {
    ...
    CACHE_METHOD(env, g_jni_cache.eccPublicKey.native_ctor,
                 g_jni_cache.eccPublicKey.cls, "<init>", "(I[B[BZ)V");
...
static jint init_ecc_signature_cache(JNIEnv *env) {
    ...
    CACHE_METHOD(env, g_jni_cache.eccSignature.native_ctor,
                 g_jni_cache.eccSignature.cls, "<init>", "([B[BZ)V");
...
static jint init_ecc_cipher_cache(JNIEnv *env) {
    ...
    CACHE_METHOD(env, g_jni_cache.eccCipher.native_ctor,
                 g_jni_cache.eccCipher.cls, "<init>", "([B[B[BJ[BZ)V");
...
static jint init_hybrid_cipher_cache(JNIEnv *env) {
    ...
    CACHE_METHOD(env, g_jni_cache.hybridCipher.native_ctor,
                 g_jni_cache.hybridCipher.cls, "<init>",
                 "(J[BJLorg/openhitls/sdf4j/types/ECCCipher;JZ)V");
...
static jint init_hybrid_signature_cache(JNIEnv *env) {
    ...
    CACHE_METHOD(env, g_jni_cache.hybridSignature.native_ctor,
                 g_jni_cache.hybridSignature.cls, "<init>",
                 "(Lorg/openhitls/sdf4j/types/ECCSignature;I[BZ)V");
