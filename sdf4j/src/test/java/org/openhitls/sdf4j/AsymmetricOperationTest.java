...
public class AsymmetricOperationTest {
    ...
    public void testGenerateECCKeyPair() throws SDFException {
        ...
        try {
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                ...
                Assume.assumeTrue("ECC 密钥对生成功能未实现", false);
            } else {
    ...
    public void testExternalECCSignVerify() throws SDFException {
        ...
        try {
            ...
            assertNotNull("verifyHash不应为空", verifyHash);
            ...
            assertNotNull("tamperedHash不应为空", tamperedHash);
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                ...
                Assume.assumeTrue("ECC 外部密钥签名验签功能未实现", false);
            } else {
                System.out.println(e.getMessage());
                throw e;
            }
    ...
    public void testExternalECCEncryptDecrypt() throws SDFException {
        ...
        try {
            ...
            assertNotNull("C1 X不应为空", cipher.getX());
            assertNotNull("C1 Y不应为空", cipher.getY());
            assertNotNull("C3 (MAC)不应为空", cipher.getM());
            assertNotNull("C2 长度不应为空", cipher.getL());
            assertNotNull("C2 (密文)不应为空", cipher.getC());
            // 步骤4: 使用外部私钥解密
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                ...
                Assume.assumeTrue("ECC 外部密钥加密解密功能未实现", false);
            } else {
                System.out.println(e.getMessage());
                throw e;
            }
    ...
    public void testInternalECCSignVerify() throws SDFException {
        ...
        try {
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                ...
                Assume.assumeTrue("ECC 内部密钥签名验签功能未实现", false);
            } else {
                System.out.println(e.getMessage());
                throw e;
            }
    ...
    public void testInternalECCEncryptDecrypt() throws SDFException {
        ...
        try {
            ...
            try {
                ...
                assertTrue("ECC 加密密钥位数应大于 0", publicKey.getBits() > 0);
                assertNotNull("ECC 加密公钥 X不应为空", publicKey.getX());
                assertNotNull("ECC 加密公钥 Y不应为空", publicKey.getY());
            } catch (SDFException e) {
                if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                ...
                Assume.assumeTrue("ECC 内部密钥加密解密功能未实现", false);
            } else {
                System.out.println(e.getMessage());
                throw e;
            }
    ...
    public void testKeyPairIsolation() throws SDFException {
        ...
        try {
            ...
            try {
                ...
                // Expected exception - verification with wrong public key should fail
            }
    ...
    public void testSignatureConsistency() throws SDFException {
        ...
        try {
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                System.out.println("[跳过] 批量内部签名验签功能未实现");
                Assume.assumeTrue("签名验签功能", false);
            } else {
                System.out.println(e.getMessage());
                throw e;
            }
    ...
    public void testExchangeDigitEnvelopeBaseOnRSA() throws SDFException {
        ...
        try {
            ...
            if (e.getErrorCode() == ErrorCode.SDR_NOTSUPPORT) {
                ...
                Assume.assumeTrue("RSA 相关功能未实现", false);
            } else {
                System.out.println(e.getMessage());
                throw e;
            }
