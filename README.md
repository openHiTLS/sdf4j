...
SDF4J 覆盖 GM/T 0018-2023 定义的常规 SDF 算法，并扩展支持混合后量子算法和纯后量子算法标识。实际可用能力仍以底层 SDF 设备库实现为准。
...
| 纯PQC签名 | ML-DSA-44/65/87 | `AlgorithmID.SGD_PQC_ML_DSA_44`、`AlgorithmID.SGD_PQC_ML_DSA_65`、`AlgorithmID.SGD_PQC_ML_DSA_87` |
| 纯PQC签名 | AIGIS-SIG1/2/3 | `AlgorithmID.SGD_PQC_AIGIS_SIG1`、`AlgorithmID.SGD_PQC_AIGIS_SIG2`、`AlgorithmID.SGD_PQC_AIGIS_SIG3` |
| 纯PQC KEM | ML-KEM-512/768/1024 | `AlgorithmID.SGD_PQC_ML_KEM_512`、`AlgorithmID.SGD_PQC_ML_KEM_768`、`AlgorithmID.SGD_PQC_ML_KEM_1024` |
...
纯后量子接口包括 `SDF_ExportPublicKey_PQC`、`SDF_InternalSign_PQC`、`SDF_InternalVerify_PQC`、`SDF_ExternalVerify_PQC`、`SDF_GenerateKeyWithIPK_PQC`、`SDF_GenerateKeyWithEPK_PQC`、`SDF_ImportKeyWithISK_PQC`。
